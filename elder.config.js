...
module.exports = {
    // TODO: update this. The URL of your site's root, without a trailing slash
    origin: process.env.HTML_ROOT || '',
    lang: 'en',
    srcDir: 'src',
    distDir: 'public',
    rootDir: process.cwd(),
    ...
    plugins: {
        '@elderjs/plugin-markdown': {
            routes: ['posts'],
            useGitHubFriendlyMarkdown: true, // enable tables
            createRoutes: false, // create routes manually in src/posts/route.js
        },
